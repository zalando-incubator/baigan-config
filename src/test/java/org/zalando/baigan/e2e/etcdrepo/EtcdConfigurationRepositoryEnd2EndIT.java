...
import org.zalando.baigan.repository.EtcdConfigurationRepository;
...
public class EtcdConfigurationRepositoryEnd2EndIT {
    ...
    static class RepoConfig {
        ...
        EtcdConfigurationRepository configurationRepository(GenericContainer<?> etcd, RepositoryFactory repositoryFactory) {
            return repositoryFactory.etcdConfigurationRepository().etcdUrl("http://localhost:" + etcd.getMappedPort(2379)).build();
        }
